...
Route::get('/cart/show', [ShoppingController::class, 'show']);
Route::get('/cart/add', [ShoppingController::class, 'Add']);
Route::post('/cart/update', [ShoppingController::class, 'update']);
Route::get('/cart/remove', [ShoppingController::class, 'remove']);
